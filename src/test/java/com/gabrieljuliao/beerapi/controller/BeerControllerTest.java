package com.gabrieljuliao.beerapi.controller;

import com.gabrieljuliao.beerapi.builder.BeerDTOBuilder;
import com.gabrieljuliao.beerapi.dto.BeerDTO;
import com.gabrieljuliao.beerapi.dto.QuantityDTO;
import com.gabrieljuliao.beerapi.exception.BeerNotFoundException;
import com.gabrieljuliao.beerapi.service.BeerService;
import com.gabrieljuliao.beerapi.utils.JsonConversionUtils;
...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                        ...
                        .content(JsonConversionUtils.asJsonString(beerDTO)))
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOKstatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch(BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUB_PATH_INCREMENT_URL)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(JsonConversionUtils.asJsonString(quantityDTO))).andExpect(status().isOk())
                .andExpect(jsonPath("$.name", is(beerDTO.getName())))
                .andExpect(jsonPath("$.brand", is(beerDTO.getBrand())))
                .andExpect(jsonPath("$.type", is(beerDTO.getType().toString())))
